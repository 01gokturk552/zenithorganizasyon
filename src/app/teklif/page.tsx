      ...
      <main>
        ...
        <section className="min-h-[60vh] flex items-center justify-center bg-[#f8f9fc]">
          <div className="text-center max-w-md mx-auto px-4">
            ...
            <h2 className="text-3xl font-black text-[#0d1b3e] mb-4">Teklif Talebiniz Alındı!</h2>
            <p className="text-[#0d1b3e]/60 mb-4">
            ...
            <form onSubmit={(e) => { e.preventDefault(); setSubmitted(true); }} className="p-8 space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-[#0d1b3e]/70 mb-2">Firma / Kurum Adı</label>
                  <input
                    type="text"
                    value={form.firma}
                ...
                <div>
                  <label className="block text-sm font-medium text-[#0d1b3e]/70 mb-2">Yetkili Ad Soyad *</label>
                  <input
                    required
                    type="text"
                    value={form.ad}
              ...
              <div>
                <label className="block text-sm font-medium text-[#0d1b3e]/70 mb-3">Etkinlik Tipi</label>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-[#0d1b3e]/70 mb-2">Etkinlik Tarihi</label>
                  <input
                    type="date"
                    value={form.tarih}
                ...
                <div>
                  <label className="block text-sm font-medium text-[#0d1b3e]/70 mb-2">Tahmini Katılımcı Sayısı</label>
                  <input
                    type="number"
                ...
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-[#0d1b3e]/70 mb-2">Etkinlik Şehri</label>
                  <input
                    type="text"
                    value={form.sehir}
              ...
              <div>
                <label className="block text-sm font-medium text-[#0d1b3e]/70 mb-3">İhtiyaç Duyulan Hizmetler</label>
              ...
              <div>
                <label className="block text-sm font-medium text-[#0d1b3e]/70 mb-2">Ek Notlar</label>
                <textarea
                  rows={3}
                  value={form.notlar}
              ...
              <button
                type="submit"
                className="w-full flex items-center justify-center gap-2 bg-[#0d1b3e] text-white py-4 rounded-xl font-bold text-lg hover:bg-[#152552] transition-all"
              >
